...
!function(e, t) {
    ...
    const e = {}
      , t = t => new Promise((o => {
        ...
        e.restoreFocusTimeout = setTimeout(( () => {
            e.previousActiveElement instanceof HTMLElement ? (e.previousActiveElement.focus(),
            e.previousActiveElement = null) : document.body && document.body.focus(),
            o()
        }
        ), 100),
        window.scrollTo(n, i)
    ...
    e)), {})
      , s = ["success", "warning", "info", "question", "error"].reduce(( (e, t) => (e[t] = n + t,
    e)), {})
      , r = "SweetAlert2:"
      ...
      , V = (e, t, o) => {
        ...
        t.customClass && t.customClass[o]) {
            if ("string" != typeof t.customClass[o] && !t.customClass[o].forEach)
                return void l(`Invalid type of customClass.${o}! Expected string or iterable object, got "${typeof t.customClass[o]}"`);
            R(e, t.customClass[o])
        }
    }
      , N = (e, t) => {
      ...
      , z = (e, t) => {
        ...
        for (let e = 0; e < o.length; e++) {
            const n = o[e];
            if (n instanceof HTMLElement && q(n, t))
                return n
        }
    }
      , W = (e, t, o) => {
        o === `${parseInt(o)}` && (o = parseInt(o)),
        o || 0 === parseInt(o) ? e.style[t] = "number" == typeof o ? `${o}px` : o : e.style.removeProperty(t)
    }
      , K = function(e) {
      ...
      , ie = e => {
        const t = ( () => {
            const e = f();
            return !!e && (e.remove(),
            U([document.documentElement, document.body], [i["no-backdrop"], i["toast-shown"], i["has-column"]]),
            !0)
        }
        )();
        if (te())
      ...
      , ce = (e, t) => {
        ...
        function(e, t, o) {
            ...
            function(e, t, o, n) {
                ...
                n.denyButtonColor && (t.style.backgroundColor = n.denyButtonColor,
                R(t, i["default-outline"]));
                n.cancelButtonColor && (o.style.backgroundColor = n.cancelButtonColor,
                R(o, i["default-outline"]))
            }(n, s, r, o),
            o.reverseButtons && (o.toast ? (e.insertBefore(r, n),
            e.insertBefore(s, n)) : (e.insertBefore(r, t),
            e.insertBefore(s, t),
            e.insertBefore(n, t)))
        }(o, n, t),
        D(n, t.loaderHtml),
    ...
    const de = (e, t) => {
        ...
        function(e, t) {
            t in i ? R(e, i[t]) : (l('The "position" parameter is not valid, defaulting to "center"'),
            R(e, i.center))
        }(o, t.position),
        function(e, t) {
        ...
        return setTimeout(( () => {
            if ("MutationObserver"in window) {
                ...
                new MutationObserver(( () => {
                    ...
                    parseInt(window.getComputedStyle(n).marginLeft) + parseInt(window.getComputedStyle(n).marginRight));
                    var n;
    ...
    const Ce = (e, t) => {
      ...
      , xe = e => {
        ...
        return R(t, i["progress-step"]),
        D(t, e),
        t
    }
      , Te = e => {
        const t = document.createElement("li");
        return R(t, i["progress-step-line"]),
      ...
      , Le = (e, t) => {
        ...
        ( (e, t) => {
            ...
            if (t.icon || t.iconHtml) {
                if (t.icon && -1 === Object.keys(s).indexOf(t.icon))
                    return c(`Unknown icon! Expected "success", "error", "warning", "info" or "question", got "${t.icon}"`),
                    void Y(i);
                K(i),
                Be(i, t),
                Ae(i, t),
                R(i, t.showClass.icon)
            } else
                Y(i)
        }
        )(e, t),
        ...
        ( (e, t) => {
            const o = C();
            o && (J(o, t.title || t.titleText, "block"),
      ...
      , De = (e, t, n) => {
        ...
        i && (t.isComposing || 229 === t.keyCode || (i.stopKeydownPropagation && t.stopPropagation(),
        "Enter" === t.key ? qe(e, t, i) : "Tab" === t.key ? Ve(t) : [...Ie, ...He].includes(t.key) ? Ne(t.key) : "Escape" === t.key && Fe(t, i, n)))
    }
      , qe = (e, t, o) => {
      ...
      , Ne = e => {
        ...
        for (let e = 0; e < L().children.length; e++) {
            ...
            !n)
                return;
            if (n instanceof HTMLButtonElement && X(n))
                break
        }
        n instanceof HTMLButtonElement && n.focus()
    }
      , Fe = (e, t, o) => {
        p(t.allowEscapeKey) && (e.preventDefault(),
        o(Oe.esc))
    }
    ;
    var _e = {
    ...
    let Ze = null;
    const Je = () => {
        null === Ze && document.body.scrollHeight > window.innerHeight && (Ze = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")),
    ...
    ;
    function Xe(o, n, s, r) {
        H() ? st(o, r) : (t(s).then(( () => st(o, r))),
        Me(e));
        /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (n.setAttribute("style", "display:none !important"),
        n.removeAttribute("class"),
        n.innerHTML = "") : n.remove(),
        I() && (null !== Ze && (document.body.style.paddingRight = `${Ze}px`,
        Ze = null),
        ( () => {
    ...
    const Qe = e => {
        ...
        R(t, n.hideClass.popup);
        const i = f();
        return U(i, n.showClass.backdrop),
    ...
    const tt = e => {
      ...
      , nt = (e, t, o) => {
        ...
        i ? it(e, t, n, o.returnFocus, o.didClose) : Xe(e, n, o.returnFocus, o.didClose)
    }
      , it = (t, o, n, i, s) => {
        e.swalCloseEventFinishedCallback = Xe.bind(null, t, n, i, s),
        o.addEventListener(le, (function(t) {
            t.target === o && (e.swalCloseEventFinishedCallback(),
      ...
      , dt = (e, t) => {
        ...
        ;
        m(t.inputOptions) || h(t.inputOptions) ? (rt(E()),
      ...
      , ft = (e, t) => {
        const n = o.innerParams.get(e);
        if (!n.input)
            return void c(`The "input" parameter is needed to be set when using returnInputValueOn${a(t)}`);
        const i = ( (e, t) => {
            const o = e.getInput();
            if (!o)
                return null;
        ...
        n.inputValidator ? bt(e, i, t) : e.getInput().checkValidity() ? "deny" === t ? yt(e, i) : Ct(e, i) : (e.enableButtons(),
      ...
      , Ct = (e, t) => {
        const n = o.innerParams.get(e || void 0);
        if (n.showLoaderOnConfirm && rt(),
        n.preConfirm) {
            e.resetValidationMessage(),
            e.isAwaitingPromise = !0;
            Promise.resolve().then(( () => g(n.preConfirm(t, n.validationMessage)))).then((o => {
                X(P()) || !1 === o ? (e.hideLoading(),
                tt(e)) : wt(e, void 0 === o ? t : o)
            }
            )).catch((t => vt(e || void 0, t)))
        } else
            wt(e, t)
    ...
    function zt() {
        const t = o.domCache.get(this)
          , n = o.innerParams.get(this);
        n ? (t.popup && e.swalCloseEventFinishedCallback && (e.swalCloseEventFinishedCallback(),
        delete e.swalCloseEventFinishedCallback),
    ...
    const Wt = t => {
      ...
      , Kt = e => {
        e.isAwaitingPromise ? (Yt(o, e),
        e.isAwaitingPromise = !0) : (Yt(_e, e),
        Yt(o, e),
    ...
    var lo = Object.freeze({
        ...
        bindClickHandler: function() {
            ro[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this,
            so || (document.body.addEventListener("click", ao),
            so = !0)
        },
        clickCancel: () => $() && $().click(),
        clickConfirm: Se,
    ...
    const uo = ["swal-title", "swal-html", "swal-footer"]
      ...
      , ho = e => {
        ...
        return o && (vo(o, ["src", "width", "height", "alt"]),
      ...
      , bo = e => {
        ...
        o && (vo(o, ["type", "label", "placeholder", "value"]),
      ...
      , Co = t => {
        ...
        I() && (Bo(o, t.scrollbarPadding, s),
        Array.from(document.body.children).forEach((e => {
            e === f() || e.contains(f()) || (e.hasAttribute("aria-hidden") && e.setAttribute("data-previous-aria-hidden", e.getAttribute("aria-hidden") || ""),
      ...
      , Ao = e => {
        ...
        if (e.target !== t)
            return;
        const o = f();
        t.removeEventListener(le, Ao),
        o.style.overflowY = "auto"
    }
      , ko = (e, t) => {
        le && Q(t) ? (e.style.overflowY = "hidden",
        t.addEventListener(le, Ao)) : e.style.overflowY = "auto"
    }
      , Bo = (e, t, o) => {
        ( () => {
    ...
    const Lo = (t, n, i) => new Promise(( (s, r) => {
        ...
        ,
        ( (e, t, n) => {
            o.innerParams.get(e).toast ? Jt(e, t, n) : (Qt(t),
            eo(t),
            to(e, t, n))
        }
        )(t, n, a),
        ( (e, t, o, n) => {
            Me(t),
            o.toast || (t.keydownHandler = t => De(e, t, n),
        ...
        ( (e, t) => {
            "select" === t.input || "radio" === t.input ? dt(e, t) : ["text", "email", "number", "tel", "textarea"].includes(t.input) && (m(t.inputValue) || h(t.inputValue)) && (rt(E()),
            pt(e, t))
        }
        )(t, i),
        Co(i),
      ...
      , So = (e, t) => {
        ...
        return n.showClass = Object.assign({}, Mt.showClass, n.showClass),
      ...
      , Oo = e => {
        ...
        return o.domCache.set(e, t),
        t
    }
      , Mo = (e, t, o) => {
        const n = O();
        Y(n),
        t.timer && (e.timeout = new co(( () => {
            o("timer"),
            delete e.timeout
        }
        ),t.timer),
        t.timerProgressBar && (K(n),
      ...
      , Io = (e, t) => t.focusDeny && X(e.denyButton) ? (e.denyButton.focus(),
    !0) : t.focusCancel && X(e.cancelButton) ? (e.cancelButton.focus(),
    !0) : !(!t.focusConfirm || !X(e.confirmButton)) && (e.confirmButton.focus(),
    !0)
      , Ho = () => {
